...
<body>
    ...
    <nav class="nav-container">
        <!-- left -->
        <img class="logo" src="../image/garibnath.jpg" alt="error in the code">

        <!-- middle container -->
        <div class="header">
            <h1 class="header-item">GARIBNATH <span style="color: #04afa9;">ENTERPRISE</span></h1>
        </div>
        <!-- last -->
        <h3 class="download-btn">Stone crusher all parts.</h3>
    </nav>

    <h2 class="product-header centered" style="background-color:black;">NUT BOLT</h2>
