...
<body>
    ...
    <nav class="nav-container">
        <!-- left -->
        <img class="logo" src="/ashish/image/garibnath.jpg" alt="error in the code">
    ...
    <h2 class="product-header centered"style="background-color:black;">CRENK BEARING</h2>
